...
---
## eBooks
- [Annas Archive](https://annas-archive.org/) [!badge variant="contrast" size="xs" text="Inclui a Z-Library"]
- [Libgen](https://libgen.fun/), [2](https://libgen.rs/), [3](https://libgen.is/), [4](https://libgen.st/)
...
- [Z-Library](https://singlelogin.re/)
    - Se registre e siga as instruções
    - [Aplicativo para Android](https://www.fireload.com/dd08ce72de596343/z-library.apk)
===
